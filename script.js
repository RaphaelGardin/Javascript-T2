      ...
      if (data.length > 0) {
       ...
       .then((res) => {
        if (res) {
          ...
          document.getElementById("sensacaoTermica").innerText = feelsLike + "°C";
          document.getElementById("descricaoClima").innerText = descricao;
        }
      })
      .catch((error) => {
        console.error("Erro na consulta:", error);
        document.getElementById("resultadoCondicõesAtuais").innerText =
